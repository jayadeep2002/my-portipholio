            ...
            <div className="container">
                ...
                >
                    <p className="contact-description">
                        ...
                        <br /><br />
                        <strong>Phone:</strong> <a href="tel:+919160286679">9160286679</a><br />
                        <strong>Email:</strong> <a href="mailto:cjaideepsai@gmail.com">cjaideepsai@gmail.com</a>
                    </p>
                    <a href="mailto:cjaideepsai@gmail.com" className="btn btn-primary contact-btn">Say Hello</a>
